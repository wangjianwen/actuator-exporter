...
public class Metric<T extends Number> {
    ...
    public int hashCode() {
        ...
        result = prime * result + Objects.hashCode(this.timestamp);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Metric) {
            ...
            boolean rtn = true;
            rtn = rtn && Objects.equals(this.name, other.name);
            rtn = rtn && Objects.equals(this.timestamp, other.timestamp);
            rtn = rtn && Objects.equals(this.value, other.value);
            return rtn;
        }
